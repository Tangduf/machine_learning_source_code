...
class SVM(object):
	...
	def calculate_fx(self,i,dataMatrix,labelMatrix,m,b,alphas):
		fx = 0
		for k in range(m):
			fx += alphas[k]*labelMatrix[k]*self.svm_kernel(self.kernel,dataMatrix[k],dataMatrix[i])
		return fx

	def calculate_error(self,i,dataMatrix,labelMatrix,m,b,alphas):
		fx = 0
		for j in range(m):
	...
	def take_step(self,i,j,dataMatrix,labelMatrix,m,b,alphas):
	...
	def examine_example(self,i,dataMatrix,labelMatrix,m,b,alphas):
